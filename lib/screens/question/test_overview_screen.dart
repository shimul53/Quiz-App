...
import 'package:quiz_app/widgets/common/background_decoration.dart';
import 'package:quiz_app/widgets/common/custom_app_bar.dart';
import 'package:quiz_app/widgets/common/main_button.dart';
import 'package:quiz_app/widgets/content_area.dart';
import 'package:quiz_app/widgets/questions/answer_card.dart';
import 'package:quiz_app/widgets/questions/countdown_timer.dart';
import 'package:quiz_app/widgets/questions/question_number_card.dart';
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Obx(
                                ()=>Text('${controller.time} Remaining',style: countdownTimerTS(),)
                        )
                      ],
                    ),
                    SizedBox(height: 20,),
                   Expanded(child:  GridView.builder(
                     ...
                     itemBuilder: (_,index){
                       ...
                       return QuestionNumberCard(
                           ...
                           onTap: ()=> controller.jumToQuestion(index)
                           );
